...
public class MyDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_AnEntry(ISerializationContext context, Map.Entry semanticObject) {
		...
		feeder.accept(grammarAccess.getAnEntryAccess().getKeyReferedTypeIDTerminalRuleCall_1_0_1(), ((EObject) semanticObject).eGet(ModelPackage.Literals.AN_ENTRY__KEY, false));
		feeder.accept(grammarAccess.getAnEntryAccess().getValueReferedTypeIDTerminalRuleCall_3_0_1(), ((EObject) semanticObject).eGet(ModelPackage.Literals.AN_ENTRY__VALUE, false));
		feeder.finish();
	}
